...
wage = input('What is your wage per hour in pounds sterling? ')
...
while True:
    name = input('What\'s your name (or \'quit\' to end)? ')
    if name == 'quit':
        break
    print('Hello', name)
...
lst = 'The cat sat on the mat'.split(' ')  # this will be ['The','cat','sat','on','the','mat']
lst.reverse()  # change the order of the list, so it will be ['mat','the','on','sat','cat','The']
